 ...
 */
public class UsuarioIF extends javax.swing.JInternalFrame {
    ...
    private void LlenarTabla() {        
        ...
        cnx.Conecta();
        try{
            String [] titulos ={"ID","Nombre","Apellido","Usuario","Contraseña"};
            ...
            JOptionPane.showMessageDialog(null, "Error LlenarTabla Usuario: " + e.getMessage());
        } finally {
            cnx.Desconecta();
        }
    }
...
//Esto métodos son par realizar acciones desde los botones
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if(i==JOptionPane.OK_OPTION){
            ...
            u.setPassword(new String(pswContrasena.getPassword()));
            u.setIdUsuario(Integer.parseInt(tblUsuario.getValueAt(fila, 0).toString()));
            u.actualizarUsuario();
        }
        LlenarTabla();
        limpiar();
    ...
    private void tblUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuarioMouseClicked
        if (evt.getButton()==1){
            ...
            cnx.Conecta();
            try{                
                String SQL = "Select * from usuario where idusuario = " + tblUsuario.getValueAt(fila, 0);
                stm = cnx.conn.createStatement();
                rs = stm.executeQuery(SQL);
